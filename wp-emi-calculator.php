...
/*section {
  background-color: rgba(238, 203, 61, 1);
  height: 100%;
  position: fixed;
  right: -740px;
  top: 0;
...
section #menuToggle span:before,
section #menuToggle span:after {
  background: white;
  content: '';
  display: block;
  height: 100%;
...
section #menuToggle span:after { top: 250%; }

section a:nth-child(n+2) {
  color: white;
  display: block;
  font-size: 2.5em;
...
section a:nth-child(n+2):hover:after { width: 100%; }
...
#menuToggle .sectionClosed:before,
#menuToggle .sectionClosed:after {
...
#menuToggle .sectionOpen:before,
#menuToggle .sectionOpen:after {
